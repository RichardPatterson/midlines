...
smooth = function(dat, width = 3){
  ...
  s = function(x){
    ...
    a = rollapply(dat$geometry[[x]][1:(l/2)], width = width, mean )
    b = rollapply(dat$geometry[[x]][(l/2+1):l], width = width, mean )
  ...
  smoothed = st_as_sf(st_as_sfc(lapply(1:nrow,s)))
